...
use tracing::error;
use crate::infrastructure::enums::{Action, ScreenState};
...
pub struct Styles(pub HashMap<ScreenState, HashMap<String, Style>>);
...
impl<'de> Deserialize<'de> for Styles {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let parsed_map = HashMap::<ScreenState, HashMap<String, String>>::deserialize(deserializer)?;
...
#[derive(Clone, Debug, Default, Deref, DerefMut)]
pub struct KeyBindings(pub HashMap<ScreenState, HashMap<Vec<KeyEvent>, Action>>);
...
impl<'de> Deserialize<'de> for KeyBindings {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let parsed_map = HashMap::<ScreenState, HashMap<String, Action>>::deserialize(deserializer)?;
